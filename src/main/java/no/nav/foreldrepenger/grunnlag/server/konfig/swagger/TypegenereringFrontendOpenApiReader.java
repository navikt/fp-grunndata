 ...
 *  2) Registere ModulConverter med egendefinert JsonMapper i henhold til hva frontend forventer
 */
public class TypegenereringFrontendOpenApiReader extends Reader {
    ...
    private static void lagCustomModelConvertersForFrontendTypegenerering() {
        ...
        // Det er ingen JsonSubTypes/JsonTypeName her, men holder denne lik andre slike klasser
        ...
        ModelConverters.getInstance().addConverter(new ModelResolver(lagSorterendeObjectMapper(),  typeNameResolver));
    ...
    private static JsonMapper lagSorterendeObjectMapper() {
